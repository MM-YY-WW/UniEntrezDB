...
gene_association2_1 = pd.read_csv("Go_annotation/extra_go/pombase/annotation_files/gene_association_2-1.pombase", sep='\t')
gene_association2_1.columns = columns16
gene_association2_2 = pd.read_csv("Go_annotation/extra_go/pombase/annotation_files/gene_association_2-2.pombase", sep='\t', skiprows=5)
gene_association2_2.columns = columns16
gene_association = pd.read_csv("Go_annotation/extra_go/pombase/annotation_files/gene_association.pombase", sep='\t', skiprows=5)
...
combine.to_csv("Go_annotation/extra_go/pombase/combine.gaf", sep='\t', header=True, index=False)



print(len(combine))
combine = pd.read_csv("Go_annotation/extra_go/pombase/combine.gaf", sep='\t')
...
print('\n')
print(len(unientrez))
unientrez.to_csv("Go_annotation/extra_go/pombase/unientrez_files/uni_all.csv", sep='\t', header=True, index=False)
