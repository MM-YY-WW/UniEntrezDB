...
combine = pd.read_csv("Go_annotation/extra_go/ToxoDB/combine.gaf", sep='\t', usecols=['DB'], comment="!")
print(set(combine['DB']))
print(len(combine))
combine = pd.read_csv("Go_annotation/extra_go/ToxoDB/combine.gaf", sep='\t', comment="!")
...
if not os.path.exists("Go_annotation/extra_go/ToxoDB/unientrez_files"):
    os.makedirs("Go_annotation/extra_go/ToxoDB/unientrez_files")
unientrez.to_csv("Go_annotation/extra_go/ToxoDB/unientrez_files/uni_all.csv", sep='\t', header=True, index=False)
