...
combine = pd.read_csv("Go_annotation/extra_go/GiardiaDB/combine.gaf", sep='\t', usecols=['DB'])
print(set(combine['DB']))
print(len(combine))
combine = pd.read_csv("Go_annotation/extra_go/GiardiaDB/combine.gaf", sep='\t')
...
if not os.path.exists("Go_annotation/extra_go/GiardiaDB/unientrez_files"):
    os.makedirs("Go_annotation/extra_go/GiardiaDB/unientrez_files")
unientrez.to_csv("Go_annotation/extra_go/GiardiaDB/unientrez_files/uni_all.csv", sep='\t', header=True, index=False)
